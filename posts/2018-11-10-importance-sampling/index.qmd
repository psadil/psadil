...
```{r}
#| label: mismatch
#| fig-cap: "h(x) (black) has mostly 0 around where p_X (blue) has high density. The mismatch of these distributions will contribute to unnecessarily high variance of the estimator."
...
```{r}
#| label: matching
#| fig-cap: "Same as above, but with line demonstrating intersection at x=2"
