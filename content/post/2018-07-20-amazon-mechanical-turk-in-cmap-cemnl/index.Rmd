...
* We need some way to code the experiment 
  ...
  + Languages
    - Javascript [w3schools](www.w3schools.com/js/default.asp)
    - CSS [w3schools](www.w3schools.com/css/default.asp)
    - HTML [w3schools](www.w3schools.com/html/default.asp)
  + Useful concepts
    - Turns out that, in javascript, line 2 might not run after line 1! It's helpful to read about [asynchronous programming in javascript](javascript.info/callbacks)
    - [Static sites, dynamic sites, and static site generators](about.gitlab.com/2016/06/03/ssg-overview-gitlab-pages-part-1-dynamic-x-static/)
...
* We need some way to organize that experimental code such that it is advertised to turkers, Amazon is informed when a Turker finishes the experiment, their responses are stored in a database, and we can approve the turkers' work 
  + Packages
    - [psiturk](psiturk.readthedocs.io/en/latest/)
    - [flask](flask.pocoo.org/docs/1.0/#)
    - [jinja](www.palletsprojects.com/p/jinja/)
  + Languages
    - [Python](python.swaroopch.com/), [Anaconda distribution](www.anaconda.com/download/)
    - [SQLite](cran.r-project.org/web/packages/dbplyr/vignettes/dbplyr.html)
  + Useful concepts
    - [what is a database?](taylorwhitten.github.io/blog/RSQLite1)
    - [what is an ip address?](www.howtogeek.com/66214/how-to-forward-ports-on-your-router/)
    - Psiturk runs on python 2, not python 3. You may want to be using an [Anaconda virtual environment](conda.io/docs/user-guide/tasks/manage-environments.html)

* We need a server to host the above components such that they are accessible via an internet connection 
  + Services
    - Amazon Mechanical Turk: follow the [psiturk documentation!](psiturk.readthedocs.io/en/latest/amt_setup.html#)
    - Amazon EC2: follow the [psiturk documentation!](psiturk.readthedocs.io/en/latest/amazon_ec2.html)
  + useful concepts
...
* Do read the tutorial on [asynchronous programming in javascript](javascript.info/callbacks). It can be really confusing when you're trying to debug and variables aren't defined
